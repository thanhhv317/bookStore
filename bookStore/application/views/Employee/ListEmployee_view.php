...
<div class="row">
    <div class="col-md-12">
        <div class="box box-green">
            <div class="box-title">
                <h3><i class="fa fa-user"></i> Danh sách nhân viên</h3>
                <div class="box-tool">
                            ...
                            <tr class="table-flag-blue">
                                ...
                                <td class="visible-md visible-lg">
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-sm btn-danger show-tooltip delete-employee" title="Delete" onclick="getIDBook('<?php echo $value['ID']; ?>')" ><i class="fa fa-trash-o"></i></a>
                                    </div>
                                </td>
                            </tr>
...
<script>
    ...
    $(".view-detail").click(function(event) {
        $.ajax({
            url: '../Employee/viewEmployeeByID/'+id,
