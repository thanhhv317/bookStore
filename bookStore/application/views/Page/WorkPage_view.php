	...
	<div class="container-wrap">		
		<div id="fh5co-work">
			...
			<div class="col-md-12 text-center">
				<button class="btn btn-success load-more">xem thêm</button>
			</div>
		</div>
...
<script>
	...
	var author ="";
	var position =12;
	var countBook = <?php echo $countbook[0]['count']; ?>;
...
$( document ).ready(function() {
	...
	function getContentKind(idkind){
		$.ajax({
			url: '../Home/getListBookByKind/'+idkind,
			type: 'POST',
			dataType: 'json',
			success: function(data){
	...
	$('.load-more').click(function(event) {
		$.ajax({
			url: '../Home/loadMoreBook/'+position,
			success: function(data){
				$('.contentBook').append(data);
			}
		});
		position+=12;
		if(position>=countBook){
			$(this).hide();
		}
	});
